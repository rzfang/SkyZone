<!-- don't use <icon-*> directly, use <icon> with 'nm' attribute. -->

<icon>
  <i data-is='icon-{opts.nm}' sz={opts.sz || 18} clr={opts.clr}/>
  <style scoped>
...
<icon-text>
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" riot-width={opts.sz} riot-height={opts.sz} viewBox="0 0 32 32">
...
<icon-images>
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" riot-width={opts.sz} riot-height={opts.sz} viewBox="0 0 36 32">
