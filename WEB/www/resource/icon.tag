<icon-text>
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={opts.sz || 18} height={opts.sz || 18} viewBox="0 0 32 32">
    ...
    <path fill={opts.clr || '#202020'} d="M23 26h-14c-0.552 0-1-0.448-1-1s0.448-1 1-1h14c0.552 0 1 0.448 1 1s-0.448 1-1 1z"></path>
    <path fill={opts.clr || '#202020'} d="M23 22h-14c-0.552 0-1-0.448-1-1s0.448-1 1-1h14c0.552 0 1 0.448 1 1s-0.448 1-1 1z"></path>
    <path fill={opts.clr || '#202020'} d="M23 18h-14c-0.552 0-1-0.448-1-1s0.448-1 1-1h14c0.552 0 1 0.448 1 1s-0.448 1-1 1z"></path>
  </svg>
  <style scoped>
    :scope { display: inline-block; }
    :scope>svg { vertical-align: middle; }
  </style>
</icon-text>
...
<icon-image>
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={opts.sz || 18} height={opts.sz || 18} viewBox="0 0 32 32">
    ...
    <path fill={opts.clr || '#202020'} d="M26 9c0 1.657-1.343 3-3 3s-3-1.343-3-3 1.343-3 3-3 3 1.343 3 3z"></path>
    <path fill={opts.clr || '#202020'} d="M28 26h-24v-4l7-12 8 10h2l7-6z"></path>
  </svg>
  <style scoped>
    :scope { display: inline-block; }
    :scope>svg { vertical-align: middle; }
...
<icon-images>
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={opts.sz || 18} height={opts.sz || 18} viewBox="0 0 36 32">
    ...
    <path fill={opts.clr || '#202020'} d="M30 11c0 1.657-1.343 3-3 3s-3-1.343-3-3 1.343-3 3-3 3 1.343 3 3z"></path>
    <path fill={opts.clr || '#202020'} d="M32 28h-24v-4l7-12 8 10h2l7-6z"></path>
  </svg>
  <style scoped>
    :scope { display: inline-block; }
    :scope>svg { vertical-align: middle; }
...
<icon-tags>
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={opts.sz || 18} height={opts.sz || 18} viewBox="0 0 40 32">
    ...
    <path fill={opts.clr || '#202020'} d="M4 17l17-17h-2.5c-0.825 0-1.977 0.477-2.561 1.061l-14.879 14.879c-0.583 0.583-0.583 1.538 0 2.121l12.879 12.879c0.583 0.583 1.538 0.583 2.121 0l0.939-0.939-13-13z"></path>
  </svg>
  <style scoped>
    :scope { display: inline-block; }
    :scope>svg { vertical-align: middle; }
...
<icon-calendar>
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={opts.sz || 18} height={opts.sz || 18} viewBox="0 0 32 32">
    <path fill={opts.clr || '#202020'} d="M10 12h4v4h-4zM16 12h4v4h-4zM22 12h4v4h-4zM4 24h4v4h-4zM10 24h4v4h-4zM16 24h4v4h-4zM10 18h4v4h-4zM16 18h4v4h-4zM22 18h4v4h-4zM4 18h4v4h-4zM26 0v2h-4v-2h-14v2h-4v-2h-4v32h30v-32h-4zM28 30h-26v-22h26v22z"></path>
  </svg>
  <style scoped>
    :scope { display: inline-block; }
    :scope>svg { vertical-align: middle; }
...
<icon-facebook>
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={opts.sz || 18} height={opts.sz || 18} viewBox="0 0 32 32">
    <path fill={opts.clr || '#47639d'} d="M26.667 0h-21.334c-2.945 0-5.333 2.388-5.333 5.334v21.332c0 2.946 2.387 5.334 5.333 5.334h10.667v-14h-4v-4h4v-3c0-2.761 2.239-5 5-5h5v4h-5c-0.552 0-1 0.448-1 1v3h5.5l-1 4h-4.5v14h6.667c2.945 0 5.333-2.388 5.333-5.334v-21.332c0-2.946-2.387-5.334-5.333-5.334z"></path>
  </svg>
  <style scoped>
    :scope { display: inline-block; }
    :scope>svg { vertical-align: middle; }
