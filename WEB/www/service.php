...
switch($_POST['Cmd']) // 0~100: for SkyZone normal; 101~200: for Admin; 201~300: for RZ.
{
  ...
  case 10:
    echo System::TutorialList($_POST); // deprecated.
    break;
  ...
  case 104:
    echo Blog::Create($_POST); // migrated.
    break;
  ...
  case 107:
    echo Message::Delete($_POST); // migrated.
    break;

  case 108:
    echo ArtCorner::Create($_POST, $_FILES); // deprecated.
    break;
  ...
  case 110:
    echo Blog::Delete($_POST); // migrated.
    break;
